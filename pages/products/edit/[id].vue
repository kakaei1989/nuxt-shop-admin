<template>
    ...
    <ClientOnly fallback-tag="span" fallback="در حال بارگذاری ...">
        <FormKit type="form" @submit="edit" :incomplete-message="false" :actions="false">
            <div class="row gy-4">
                <ProductPrimaryImage :primary-image="product.primary_image" @set-primary-image="(image) => primaryImage = image" />

                <div class="col-md-3">
                    <FormKit type="text" name="name" id="name" label="نام" label-class="form-label"
                        input-class="form-control" :value="product.name" messages-class="form-text text-danger" validation="required"
                ...
                <div class="col-md-3">
                    <FormKit type="select" name="category_id" id="category_id" label="دسته بندی"
                        ...
                        validation="required" :value="product.category_id" :validation-messages="{ required: 'فیلد دسته بندی الزامیست' }">
                ...
                <div class="col-md-3">
                    <FormKit type="select" name="status" id="status" label="وضعیت" label-class="form-label"
                        input-class="form-select" :value="product.status_value" messages-class="form-text text-danger">
                ...
                <div class="col-md-3">
                    <FormKit type="text" name="price" id="price" label="قیمت" label-class="form-label"
                        input-class="form-control" :value="product.price" messages-class="form-text text-danger" validation="required|number"
                ...
                <div class="col-md-3">
                    <FormKit type="text" name="quantity" id="quantity" label="تعداد" label-class="form-label"
                        input-class="form-control" :value="product.quantity" messages-class="form-text text-danger" validation="required|number"
                ...
                <div class="col-md-3">
                    <FormKit type="text" name="sale_price" id="sale_price" label="قیمت حراجی" label-class="form-label"
                        input-class="form-control" :value="product.sale_price" messages-class="form-text text-danger" validation="number"
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" :placeholder="product.date_on_sale_from_jalali" class="form-control" id="sale-date-from-picker">
                    </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text"><i class="bi bi-clock"></i></span>
                        <input type="text" :placeholder="product.date_on_sale_to_jalali" class="form-control" id="sale-date-to-picker">
                    </div>
                ...
                <div class="col-md-12">
                    <FormKit type="textarea" rows="5" name="description" id="description" label="توضیحات"
                        label-class="form-label" :value="product.description" input-class="form-control" messages-class="form-text text-danger"
...
async function edit(data) {
    ...
    formData.append("date_on_sale_from", saleDateFrom.value ? saleDateFrom.value : product.value.date_on_sale_from);
    formData.append("date_on_sale_to", saleDateTo.value ? saleDateTo.value : product.value.date_on_sale_to);
