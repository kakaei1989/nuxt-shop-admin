        ...
        <div class="row gy-4">
            <div class="col-md-3">
                <FormKit type="text" name="code" id="code" label="کد تخفیف" label-class="form-label"
                    input-class="form-control" :value="coupon.code" messages-class="form-text text-danger"
                    validation="required" :validation-messages="{ required: 'فیلد کد تخفیف الزامیست' }" />
            </div>
            <div class="col-md-3">
                <FormKit type="text" name="percentage" id="percentage" label="درصد" label-class="form-label"
                    input-class="form-control" :value="coupon.percentage" messages-class="form-text text-danger"
            ...
            <ClientOnly>
                <div class="col-md-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" :placeholder="coupon.expired_at_jalali" class="form-control"
                            id="date-expire">
                    </div>
...
async function update(formData) {
    ...
    try {
        ...
        toast.success("ویرایش تخفیف باموفقیت انجام شد");
